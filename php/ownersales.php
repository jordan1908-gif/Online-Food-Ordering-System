...
?>
            ...
            <tr>
                ...
                <td>
                <a href="ownersales.php?id=<?php echo $id;?><#modal2?id=<?php echo $id; ?>"> <button class="btn btn-success btn-sm" style="position:absolute; margin-top: -15px; left:1370px;" data-toggle="modal" data-target="#modal2" name="edit_data"><i class="fas fa-edit"></i></button></a>
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    
                        <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                        
                        <a href="ownersales.php?id=<?php echo $id; ?>"><button class="btn btn-danger btn-sm" style="position:absolute; margin-top: -15px; left:1415px;" name="del_data"><i class="fas fa-trash"></i></button></a>
                    </form>
  ...
  <div class="modal fade" id="modal2">
    ...
    <button class = "btn btn-primary btn-sm"><a href = "chart.php" style = "text-decoration: none; color: #fff;"><i class="fas fa-chart-bar"></i> Graphical Results</a></button>
