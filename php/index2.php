...
<head>
    ...
    <title>Bake n Take Cake Menu</title>
...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
  ...
  <!-- Brand -->
  <a class="navbar-brand" href="index2.php">Bake n Take Cake Menu</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="index2.php">Cakes  &nbsp;<i class="fas fa-birthday-cake"></i></a>
      </li>
      <li class="nav-item">
