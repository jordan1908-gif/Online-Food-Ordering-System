...
<h2 style="margin-left: 290px;"><b>Search Range for Cake</b></h2><br>
...
?>
            ...
            <tr>
                ...
                <td>
                <a href="staffcakesales.php?id=<?php echo $id;?><#modal2?id=<?php echo $id; ?>"> <button class="btn btn-success btn-sm" style="position:absolute; margin-top: -15px; left:1335px;" data-toggle="modal" data-target="#modal2" name="edit_data"><i class="fas fa-edit"></i></button></a>
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                    
                        <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
                        
                        <a href="staffcakesales.php?id=<?php echo $id; ?>"><button class="btn btn-danger btn-sm" style="position:absolute; margin-top: -15px; left:1375px;" name="del_data"><i class="fas fa-trash"></i></button></a>
                    </form>
